    ...
    <div id="home-content">
      ...
      <div class="footer">
        ...
        <div id="googlePaySection">
          ...
          <a className="patreon-button link-button" data-patreon-widget-type="become-patron-button"
            href="https://www.patreon.com/user?u=99181802" rel="noreferrer" target="_blank"> <svg id="patreon-logo"
              viewBox="10 0 2560 356" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
              <g>
                <path
            ...
            <h5><address>聯絡/意見:<a id="contact-email" href="mailto:6tentalk.contact@gmail.com">6tentalk.contact@gmail.com</a></address></h5>
          <!-- <GooglePay /> -->
        </div>
      </div>
    </div>
